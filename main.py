...
class CVText(BaseModel):
    professional_summary: str = Field(..., description="The improved CV professional summary text.")
    cv_job_experience: str = Field(..., description="The improved CV job experience text.")
    ...
    key_achievements: str = Field(..., description="the improved CV key achievements text.")
